/**
 * file: perfect_long.rs
 * desc: The perfect long-read error profile. This generates phred scores using a normal
 *       distribution, generates read lengths usning a gamma distribution, and assumes a
 *       uniform probability of point mutations.
 *       
 */
